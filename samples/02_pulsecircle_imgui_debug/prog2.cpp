...
//          bind_sampler(shader[GLSL_IMAGE_PROC].program, "db_debug_digits", 10, m_texture[TEX_DEBUG_DIGITS].id);
...
//  saveTexture(m_texture[TEX_DST].id, "test.png", m_texture[TEX_DST].width, m_texture[TEX_DST].height);
